...
export default function NewPostPage() {
  ...
  return (
    <div>
      <h1 className="font-[family-name:var(--font-syne)] text-3xl font-extrabold">New post</h1>
      <p className="mt-1 text-sm text-[#e8e8ef]/45">Create a markdown post stored in the repo.</p>
      ...
      <form onSubmit={handleSubmit} className="mt-10 max-w-3xl space-y-4">
        ...
        <div>
          ...
          <input
            required
            title="Used in the URL and as the filename (English, Arabic, or mixed)"
